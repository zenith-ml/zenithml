...
from zenithml.preprocess.analyze.nvt_analyzer import NormalizeMinMaxNVTAnalyzer
from zenithml.preprocess.analyze.nvt_analyzer import NormalizeNVTAnalyzer
from zenithml.preprocess.analyze.pandas_analyzer import NumericalPandasAnalyzer
...
class Numerical(FTransformConfig):
    ...
    def tf_preprocess_layer(self):
        from zenithml.tf.layers.preprocess.numerical import NumericalLayer
...
class StandardNormalizer(Numerical):
    ...
    def torch_preprocess_layer(self):
        from zenithml.torch.layers.preprocess.normalizers import NormalizationLayer
...
class MinMaxNormalizer(Numerical):
    ...
    def tf_preprocess_layer(self):
        ...
        from zenithml.tf.layers.preprocess.normalizers import MinMaxNormalizeLayer
    ...
    def torch_preprocess_layer(self):
        from zenithml.torch.layers.preprocess.normalizers import MinMaxNormalizeLayer
...
class LogNormalizer(Numerical):
    ...
    def tf_preprocess_layer(self):
        import tensorflow as tf
        from zenithml.tf.layers.preprocess.normalizers import LogNormalizeLayer
    ...
    def torch_preprocess_layer(self):
        import torch
        from zenithml.torch.layers.preprocess.normalizers import LogNormalizeLayer
