...
from condorml.nvt.ops.vocab_categorify import VocabCategorify
...
class NVTAnalyzer(abc.ABC):
    ...
    def get_analyzers(feature):
        analyzers = feature.nvt_analyzer()
...
class NumericalNVTAnalyzer(NVTAnalyzer):
    def ops(self, **kwargs):
...
class BucketizeNVTAnalyzer(NVTAnalyzer):
    def ops(self, **kwargs) -> nvt.ops.Operator:
...
class CategoricalNVTAnalyzer(NVTAnalyzer):
